...
export { StatusChipComponent } from './lib/design-system/status-chip/status-chip.component';
export type { StatusChipStatus, StatusChipVariant, StatusChipSize, EmployeeStatus, LeaveStatus, AttendanceStatus, DocumentStatus, RequestStatus, StatusChipConfig } from './lib/design-system/status-chip/status-chip.types';
export { TableComponent } from './lib/design-system/table/table.component';
export type { TableVariant, TableSize, ColumnType, TableColumn, TableAction, TableSelection, TableConfig, TableData } from './lib/design-system/table/table.types';
...
export type { UserCardVariant, UserCardSize, UserCardAvatarPosition, UserCardData, UserCardConfig } from './lib/components/user-card/user-card.types';